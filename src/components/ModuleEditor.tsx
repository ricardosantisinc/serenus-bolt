...
import { X, Save, Loader2, Globe, Eye, Archive } from 'lucide-react';
import { Module, ModuleFormData, PublicationStatus } from '../types';
            ...
            >
              {isLoading ? (
                ...
                <>
                  ...
                  <span>{mode === 'create' ? 'Criar Módulo' : 'Salvar Alterações'}</span>
                </>
              )}
            </button>
          </div>
